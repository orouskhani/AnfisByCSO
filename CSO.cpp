...
int main(int argc, char* argv[])
{
	...
	int i_Cycle[i_FuncNum]={5, 1, 1};		// Defines the total cycle for runing this algorithm. 
	...
	int i_Iteration[i_FuncNum]={50, 1, 1}; // Defines the total iteration number in one cycle.
	...
	int i_Dim[i_FuncNum]={5, 30, 30};			// Defines the dimension of the benchmark functions.
	...
	int i_PSize[i_FuncNum]={30, 160, 160};		// Defines the population size used to run the CSO algorithm.

  double d_InitL[i_FuncNum]={-1, -1 , -32.768};       // Defines the left border of the initial ranges.
  double d_InitR[i_FuncNum]={1, 1 , 32.768};       // Defines the right border of the initial ranges.
